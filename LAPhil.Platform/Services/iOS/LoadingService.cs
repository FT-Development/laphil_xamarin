...
namespace LAPhil.Platform
{
    ...
    {
        UIImage[] loadedGIFData;

        public LoadingService()
        {
            Task.Run(() =>
            {
                loadedGIFData = getGIFdata();
            });
        }

        public UIImageView CreateIndeterminateLoader()
        {
            var imageView = new UIImageView();
            imageView.TranslatesAutoresizingMaskIntoConstraints = false;
            imageView.AnimationImages = loadedGIFData;
        ...
        public void LayoutAtTopOfViewController(UIImageView loader, UIViewController viewController)
        {
            var view = viewController.View;

            if (UIDevice.CurrentDevice.CheckSystemVersion(11, 0))
                loader.TopAnchor.ConstraintEqualToSystemSpacingBelowAnchor(view.SafeAreaLayoutGuide.TopAnchor, 0).Active = true;
            else
                loader.TopAnchor.ConstraintEqualTo(viewController.TopLayoutGuide.GetBottomAnchor(), 0).Active = true;

            loader.LeadingAnchor.ConstraintEqualTo(view.LeadingAnchor).Active = true;
            loader.TrailingAnchor.ConstraintEqualTo(view.TrailingAnchor).Active = true;
            loader.HeightAnchor.ConstraintEqualTo(7).Active = true;
        }
