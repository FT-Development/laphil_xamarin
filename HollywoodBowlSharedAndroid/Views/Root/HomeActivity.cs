...
namespace HollywoodBowl.Droid
{
    ...
    public class HomeActivity : Activity
    {
        ...
        private readonly String[] Tabs = new String[] { "ConcertsView", "MyTicketsView", "FoodAndWineView", "MoreView" };
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            tablayout.TabSelected += (object sender, TabLayout.TabSelectedEventArgs e) =>
            {
                ...
                {
                    //tablayout.GetTabAt(lastSelectTab).Select();
        ...
        private void SetupTabLayout()
        {
            ...
            tablayout.AddTab(tablayout.NewTab().SetText("Food + Wine"));
            tablayout.AddTab(tablayout.NewTab().SetText("More"));
        }
        private int[] tabIcons = {
            Resource.Drawable.tab_concerts,
            Resource.Drawable.tab_my_tickets,
            Resource.Drawable.tab_food_wine,
