...
namespace HollywoodBowl.Droid
{
    public class MoreView : Fragment
    {
        ...
        private TextView logoutTextView, faqText, supportUsText, shareAppText, gettingTextV,myAccountTextV,seatingchartTextV,mapTextV, storeText;
        private RelativeLayout btnFAQ, btnSupportUs, btnLogout, btnGettingHere, btnShareApp,btnMyAccount,btnSeatingchart,btnMapImageView, btnStore;
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            btnMapImageView.Click+=delegate {
                InteractiveMapView fragment = new InteractiveMapView();
                var transaction = FragmentManager.BeginTransaction();
                transaction.Replace(Resource.Id.Main_FragmentContainer, fragment);
                transaction.AddToBackStack(null);
                transaction.Commit();
            ...
            btnStore.Click += delegate
            {
                WhenYouHereWebViews fragment = new WhenYouHereWebViews();
                Bundle args = new Bundle();
                args.PutString("url", urlService.BowlStore);
                args.PutString("header", "The Bowl Store");
                fragment.Arguments = args;
                var transaction = FragmentManager.BeginTransaction();
                transaction.Replace(Resource.Id.Main_FragmentContainer, fragment);
                transaction.AddToBackStack(null);
        ...
        private void InitView(Context mContext, View view)
        {
            ...
            btnMapImageView = view.FindViewById<RelativeLayout>(Resource.Id.btnMapImageView);
            btnStore = view.FindViewById<RelativeLayout>(Resource.Id.btnStore);

            mapTextV = view.FindViewById<TextView>(Resource.Id.mapTextV);
            storeText = view.FindViewById<TextView>(Resource.Id.storeText);
