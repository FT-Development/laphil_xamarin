...
{
    [Register("WebGettingHereViewController")]
    public class WebGettingHereViewController : UIViewController
    {
        ...
        public WebGettingHereViewController(IntPtr handle) : base(handle)
        {
        }
        ...
        public override void ViewDidLoad()
        {
            ...
            this.NavigationItem.Title = "Getting Here";
        ...
        public override void ViewWillAppear(bool animated)
        {
            ...
            var urlsAccessibility = urls.WebGettingHere;
