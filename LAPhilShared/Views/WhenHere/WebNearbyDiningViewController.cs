...
{
    public partial class WebNearbyDiningViewController : UIViewController
    {
        ...
        public WebNearbyDiningViewController (IntPtr handle) : base (handle)
        {
        }
        ...
        public override void ViewWillAppear(bool animated)
        {
            ...
            var urlsDining = urls.WebDining;

            this.webViewSignUp.ScalesPageToFit = true;
            this.webViewSignUp.Delegate = new MyCustomWebViewDelegate();
            this.webViewSignUp.LoadRequest(new NSUrlRequest(new NSUrl(urlsDining)));
